...
class TestEventURLAPI(unittest.TestCase):
    ...
    def setUp(self):
        self.base = BASE_URL+"/api/v1.0/events"

    # test for no filter
    def test_no_filter(self):
        url_expected = BASE_URL+"/api/v1.0/events"
    ...
    def test_filter_by_sport_and_date_from(self):
        url_expected = BASE_URL+"/api/v1.0/events?sport=106&date_from=2021-06-08T18:00"
    ...
    def test_filter_by_date_from_to(self):
        url_expected = BASE_URL+"/api/v1.0/events?date_from=2021-06-08T18:00&date_to=2021-06-09T18:00"
    ...
    def test_filter_by_name_and_sport(self):
        url_expected = BASE_URL+"/api/v1.0/events?name=street&sport=106"
